...
export const GoogleGeminiEffect = ({
  ...
  return (
    <div className={cn("sticky top-40 px-4", className)}>
      ...
      >
        {title || t('data_to_insight')}
      </motion.p>
      <motion.p
        className="text-secondary-text text-xl pb-4 text-center"
        style={{ opacity: textOpacity }}
      >
        {description || t('data_power')}
      </motion.p>
      <motion.div
        className="w-full h-[390px] top-10 md:top-10 flex items-center justify-center bg-red-transparent absolute"
      ...
      <svg
        ...
        className="absolute -top-40 md:-top-20 w-full"
      >
        <motion.path
